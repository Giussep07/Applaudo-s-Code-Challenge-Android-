...
class RemoveLocalFavoriteTvShowUseCase @Inject constructor(private val tvShowRepository: TvShowRepository) {

  operator fun invoke(tvShowId: Int) =
    tvShowRepository.removeLocalFavoriteTvShow(tvShowId)
